...
var AlakartMenu = /** @class */ (function () {
    ...
    AlakartMenu.ctorParameters = function () { return [
        { type: String },
        { type: String },
        { type: Number },
        { type: Array }
...
var AlakartMenuItem = /** @class */ (function () {
    ...
    AlakartMenuItem.ctorParameters = function () { return [
        { type: String },
        { type: String },
        { type: String },
        { type: String }
...
var Firma = /** @class */ (function () {
    ...
    Firma.ctorParameters = function () { return [
        { type: String },
        { type: String },
        { type: String },
        { type: String },
...
var KeyValue = /** @class */ (function () {
    ...
    KeyValue.ctorParameters = function () { return [
        { type: Number },
        { type: String }
    ]; };
    return KeyValue;
...
var YemekMenuGun = /** @class */ (function () {
    function YemekMenuGun(Tarih, GunAd, FiyatlarGorunsunMu, ToplamFiyatGorunsunMu, ToplamFiyat, YemekMenuItems, GunBaslik, image, Aciklama, SalataMenuItems) {
        this.Tarih = Tarih;
        this.GunAd = GunAd;
    ...
    YemekMenuGun.ctorParameters = function () { return [
        { type: String },
        { type: String },
        { type: Boolean },
        { type: Boolean },
...
var YemekMenuItem = /** @class */ (function () {
    function YemekMenuItem(Fiyat, YemekAdi) {
        this.Fiyat = Fiyat;
        this.YemekAdi = YemekAdi;
    }
    YemekMenuItem.ctorParameters = function () { return [
        { type: String },
        { type: String }
    ]; };
...
var AlakartMenuComponent = /** @class */ (function () {
    ...
    AlakartMenuComponent.prototype.satirEkle = function (item) {
        var menuItem = new _models_AlakartMenuItem__WEBPACK_IMPORTED_MODULE_2__["AlakartMenuItem"]("0", "", "", "");
...
var AlakartComponent = /** @class */ (function () {
    ...
    AlakartComponent.prototype.setBosAlakartMenus = function () {
        ...
        var alakartMenu1 = new _models_AlakartMenu__WEBPACK_IMPORTED_MODULE_3__["AlakartMenu"]("12.10.2017", "Kahvaltılıklar", 200, alakartMenuItems1);
        var alakartMenu2 = new _models_AlakartMenu__WEBPACK_IMPORTED_MODULE_3__["AlakartMenu"]("12.10.2017", "Sandviçler", 200, alakartMenuItems2);
        var alakartMenu3 = new _models_AlakartMenu__WEBPACK_IMPORTED_MODULE_3__["AlakartMenu"]("12.10.2017", "Salatalar", 200, alakartMenuItems3);
        var alakartMenu4 = new _models_AlakartMenu__WEBPACK_IMPORTED_MODULE_3__["AlakartMenu"]("12.10.2017", "Yemekler", 200, alakartMenuItems4);
        var alakartMenu5 = new _models_AlakartMenu__WEBPACK_IMPORTED_MODULE_3__["AlakartMenu"]("12.10.2017", "Tatlılar", 200, alakartMenuItems5);
        var alakartMenu6 = new _models_AlakartMenu__WEBPACK_IMPORTED_MODULE_3__["AlakartMenu"]("12.10.2017", "İçecekler", 200, alakartMenuItems6);
    ...
    AlakartComponent.ctorParameters = function () { return [
...
var AlakartService = /** @class */ (function () {
    ...
    AlakartService.ctorParameters = function () { return [
...
var EkipmanComponent = /** @class */ (function () {
...
var EkipmanService = /** @class */ (function () {
    ...
    EkipmanService.ctorParameters = function () { return [
        { type: _angular_fire_database__WEBPACK_IMPORTED_MODULE_2__["AngularFireDatabase"] }
    ]; };
...
var FooterBarService = /** @class */ (function () {
    ...
    FooterBarService.ctorParameters = function () { return [
        { type: _angular_fire_database__WEBPACK_IMPORTED_MODULE_2__["AngularFireDatabase"] }
    ]; };
...
var FigureItem = /** @class */ (function () {
    function FigureItem(Baslik, ResimYol, Icerik) {
        this.Baslik = Baslik;
        this.ResimYol = ResimYol;
        this.Icerik = Icerik;
    }
    FigureItem.ctorParameters = function () { return [
        { type: String },
        { type: String },
        { type: String }
    ]; };
...
var ResimGaleriComponent = /** @class */ (function () {
    ...
    ResimGaleriComponent.ctorParameters = function () { return [
...
var ResimGaleriService = /** @class */ (function () {
    ...
    ResimGaleriService.ctorParameters = function () { return [
        { type: _angular_fire_database__WEBPACK_IMPORTED_MODULE_2__["AngularFireDatabase"] }
    ]; };
...
var HaftalikMenuComponent = /** @class */ (function () {
    ...
    HaftalikMenuComponent.prototype.ngOnInit = function () {
    ...
    HaftalikMenuComponent.prototype.haftalikMenuleriYukle = function () {
        var _this = this;
        this.YemekMenuGunListe = [];
        ...
        this.haftalikMenuService
            ...
            _this.aktifHaftaVerisiVarmi = _this.YemekMenuGunListe.filter(function (c) { return c.ToplamFiyat != 0; }).length > 0;
        });
    };
    HaftalikMenuComponent.prototype.getirPazartesiKeyGunden = function (d) {
    ...
    HaftalikMenuComponent.prototype.setBosYemekMenuItems = function () {
        ...
        for (var g = 0; g < 5; g++) {
            ...
            var gun = new _models_YemekMenuGun__WEBPACK_IMPORTED_MODULE_4__["YemekMenuGun"](tarih.toLocaleDateString("tr-TR"), this.gunler[tarih.getDay() - 1], false, true, 0, [], "", "", "", []);
            for (var i = 0; i < 5; i++) {
    ...
    HaftalikMenuComponent.prototype.yeniSatirEkle = function (m) {
        var _yeniYemekMenuItem = new _models_YemekMenuItem__WEBPACK_IMPORTED_MODULE_5__["YemekMenuItem"]("0", "");
        m.YemekMenuItems.push(_yeniYemekMenuItem);
    };
    HaftalikMenuComponent.prototype.yeniSalataSatirEkle = function (m) {
        var _yeniYemekMenuItem = new _models_YemekMenuItem__WEBPACK_IMPORTED_MODULE_5__["YemekMenuItem"]("0", "");
    ...
    HaftalikMenuComponent.prototype.changeListener = function ($event, m) {
        this.readThis($event.target, m);
    };
    HaftalikMenuComponent.prototype.readThis = function (inputValue, m) {
    ...
    HaftalikMenuComponent.prototype.resmiBuyut = function (m) {
        this.aktifResimYol = m.image;
        this.aktifResimAciklama = m.Aciklama;
        this.modalForm.nativeElement.style.display = "block";
    };
    HaftalikMenuComponent.prototype.closeModal = function () {
        this.modalForm.nativeElement.style.display = "none";
    };
    HaftalikMenuComponent.prototype.sutunSitilSinifGetir = function () {
        var sinifDizi = [];
        var fiyatGiriliSayi = this.YemekMenuGunListe.filter(function (c) { return c.ToplamFiyat != 0; }).length;
    ...
    HaftalikMenuComponent.ctorParameters = function () { return [
...
var HaftalikMenuService = /** @class */ (function () {
    function HaftalikMenuService(afDb) {
        this.afDb = afDb;
    }
    HaftalikMenuService.prototype.haftaVerileriniGetir = function (_menuAd, _yil, _ay, _pazartesiKey) {
        var yol = "/" + _menuAd + "/" + _yil + "/" + _ay + "/" + _pazartesiKey;
        return this.afDb.list(yol);
    };
    HaftalikMenuService.prototype.haftaVeriKaydet = function (_menuAd, _yil, _ay, _pazartesiKey, _haftaData) {
        var yol = "/" + _menuAd + "/" + _yil + "/" + _ay + "/" + _pazartesiKey;
        delete _haftaData['$key'];
        delete _haftaData['$exists'];
        return this.afDb.object(yol).set(_haftaData);
    };
    HaftalikMenuService.ctorParameters = function () { return [
        { type: _angular_fire_database__WEBPACK_IMPORTED_MODULE_2__["AngularFireDatabase"] }
    ]; };
...
var HakkimizdaComponent = /** @class */ (function () {
...
var IstatistikBarComponent = /** @class */ (function () {
    ...
    IstatistikBarComponent.ctorParameters = function () { return [
...
var IstatistikBarService = /** @class */ (function () {
    ...
    IstatistikBarService.ctorParameters = function () { return [
        { type: _angular_fire_database__WEBPACK_IMPORTED_MODULE_2__["AngularFireDatabase"] }
    ]; };
...
var MainSlideComponent = /** @class */ (function () {
...
var MyHighLightDirective = /** @class */ (function () {
    ...
    MyHighLightDirective.ctorParameters = function () { return [
...
var MyTabComponent = /** @class */ (function () {
...
var MyW3CarouselComponent = /** @class */ (function () {
    ...
    MyW3CarouselComponent.prototype.carousel = function (indexItem) {
        ...
        try {
            for (var _c = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](this.displayItems), _d = _c.next(); !_d.done; _d = _c.next()) {
                var item = _d.value;
        ...
        try {
            for (var _e = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](this.dotItems), _f = _e.next(); !_f.done; _f = _e.next()) {
                var item = _f.value;
                // item.classList.remove("current");
            }
        }
